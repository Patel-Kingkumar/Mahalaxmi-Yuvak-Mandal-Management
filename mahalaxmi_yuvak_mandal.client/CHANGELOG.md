...
- Create Angular project with ng: `ng new mahalaxmi_yuvak_mandal.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`mahalaxmi_yuvak_mandal.client.esproj`).
